...
int main()
{
    ...
    double distArray[20000][2];
    
    string inputfile = "C:/Users/LZH/Desktop/5.25/flag_logo/flag_logo-13000-stipple.tsp";
...
ofstream ofile;
		ofile.open(inputfile+"-2opt.tsp");
    //print route.
	for(int i=0;i<N;i++){
        ofile << i << " " << distArray[route[i]][0] << " " << distArray[route[i]][1] << endl;
