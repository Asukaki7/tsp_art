...
# stippler.py gradient.png --save --force --n_point 5000 --n_iter 50 --pointsize 1.0 1.0 --figsize 6
#
# -----------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    density = imageio.imread(filename, mode='L', pilmode='L') # Flattens into a grayscale image, 8 bit pixels, black and white
    ...
    if not os.path.exists(dat_filename) or args.force:
        ...
        points = np.load(dat_filename,allow_pickle=True)
